  ...
  useEffect(() => {
    ...
    ;(async () => {
      ...
      if (foundPost) {
        ...
        setPreview(foundPost.imageUrl || null)
      } else {
        router.push("/admin/posts")
      }
    })()
        ...
        <form onSubmit={handleSubmit}>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  {preview && (
                    <div className="mt-2">
                      <Label className="text-zinc-400 text-sm">Pr�-visualiza��o</Label>
              ...
              <div className="p-4 bg-zinc-800 rounded-lg">
                <p className="text-sm text-zinc-400">
                  <strong className="text-white">Visualizações:</strong> {post.views}
                </p>
                <p className="text-sm text-zinc-400 mt-1">
                  <strong className="text-white">Criado em:</strong>{" "}
                  {post.publishedAt ? new Date(post.publishedAt).toLocaleString("pt-BR") : "-"}
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="flex gap-4">
            ...
            >
              ...
              {post.status === "published" ? "Atualizar Publicação" : "Publicar Agora"}
            </Button>
          </div>
        </form>
      </div>
