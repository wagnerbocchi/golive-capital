...
export default function GlossarioPage() {
  const searchFundBasics = [
    "Introdução aos Search Funds",
    "O que é um Search Fund",
    "Nota para os investidores iniciantes em Search Fund",
    "Aprendendo sobre Search Fund",
    "Oportunidades e riscos de Search Fund",
    "Lista com mais de 40 dos melhores estudos de caso de Search Fund",
    "Guia Jurídico sobre Search Fund no Brasil",
  ]

  const stanfordStudies = [
    { year: "2024", title: "Estudo de 2024" },
    { year: "2022", title: "Estudo de 2022" },
    { year: "2020", title: "Estudo de 2020" },
    { year: "2018", title: "Estudo de 2018" },
    { year: "2016", title: "Estudo de 2016" },
  ]
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {searchFundBasics.map((item, index) => (
              <Card
                key={index}
                className="bg-background border-border hover:border-primary/50 transition-colors cursor-pointer group"
              >
                <CardHeader>
